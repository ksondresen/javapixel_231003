<section class="section-with-profit-text" style="display:flex;justify-content:center; align-items:center; height: 300px;">
    ...
    <section class="section-grey-container" style="position: relative; height: 300px;background-color:#fffaf5ff; display: flex; justify-content:center; align-items:center; gap: 30px">
      ...
      <div class="container-marketing-text-and-button" style="z-index: 1;display:flex; flex-direction: column;gap:10px; width: 320px">
        ...
        <button id="myBtn" style="all: unset; align-self: flex-start;margin-top: 10px;background-color: #cdf4ffff; color:#152f08; border-radius: 5px; padding: 10px 20px; text-align: center"><p>Se tjenestene vi tilbyr</p></button>        
      </div>
</p>
    </section>